...
var searchCode = function searchCode() {
  document.querySelector('form').addEventListener('submit', function (e) {
    ...
    var place = document.querySelector('.result');
    var searchResponse;
    (0,_ajaxService__WEBPACK_IMPORTED_MODULE_0__["default"])(searchTerm, city, place).then(function (result) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkjavascript_06"] = self["webpackChunkjavascript_06"] || [];
